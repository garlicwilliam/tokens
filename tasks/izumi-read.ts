        ...
        "inputs": [
            {
                "components": [
                    ...
                    {"internalType": "uint128", "name": "xLim", "type": "uint128"},
                    {"internalType": "uint128", "name": "yLim", "type": "uint128"},
                    {
                        "internalType": "uint128",
                        "name": "amountXMin",
                        "type": "uint128"
        ...
        "inputs": [
            {
                "components": [
                    ...
                    {"internalType": "address", "name": "tokenY", "type": "address"},
                    {"internalType": "uint24", "name": "fee", "type": "uint24"},
                    {"internalType": "int24", "name": "pl", "type": "int24"},
                    {"internalType": "int24", "name": "pr", "type": "int24"},
                    {"internalType": "uint128", "name": "xLim", "type": "uint128"},
                    {"internalType": "uint128", "name": "yLim", "type": "uint128"},
                    {
                        "internalType": "uint128",
...
const provider = new ethers.JsonRpcProvider('https://lb.drpc.org/ogrpc?network=scroll&dkey=AsQlBGo230qhhptQOBJcQ_B0i7uWnPAR76ThFhW5UfFk');
const izumiPosContract: Contract = new ethers.Contract('0x1502d025BfA624469892289D45C0352997251728', izumiPosAbi, provider);

// 104728
// 104729
from(izumiPosContract.liquidities(104729n)).subscribe({
    next: (rs) => {
        console.log(rs);
    }
})
